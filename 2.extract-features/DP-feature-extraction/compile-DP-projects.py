...
nuc_project_path = pathlib.Path(
    "/media/roshankern/63af2010-c376-459e-a56e-576b170133b6/data/cell-health-nuc-DP/"
)
...
DPutils.compile_project(
    nuc_project_path, checkpoint_name, annotations_path, images_load_path, "nuc"
)
